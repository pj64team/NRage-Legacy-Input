RELEASE Version 2.5.4 for Legacy 1.6.2
...
Release 2.5.4
/Added support for N64 Mouse (Thanks LuigiBlood)
/Added option to allow background input (if emu window isn't focused)
/Fixed binding of C-buttons in Xinput mode
/Reduced deadzone max value to be more accurate to real N64 analog stick (Buck Bumble should work now)
/Misc customizations and bugfixes provided by zilmar
